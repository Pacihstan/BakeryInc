...
func _ready():
	$database_interface.configureConnection("Data Source=LAPTOP-DG7JVPNB\\SQLEXPRESS;Initial Catalog=Bakery Database;Integrated Security=True;TrustServerCertificate=True")
